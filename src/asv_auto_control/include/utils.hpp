...
namespace utils{
    inline double rosRateToSec(ros::Rate rr_){
        return 1.0 / rr_.expectedCycleTime().sec;
    }
...
//    }
    ...
    inline double calculateDistance(geometry_msgs::Point p1, geometry_msgs::Point p2){
        return calculateResultant(p1.x-p2.x, p1.y-p2.y);
    }
    ...
    inline double getAngleInvert(const geometry_msgs::Point& p1, const geometry_msgs::Point& p2){
